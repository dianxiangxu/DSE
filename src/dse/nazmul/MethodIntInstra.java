...
public class MethodIntInstra extends BodyTransformer 
{
    ...
    static 
    {
        ...
        isInt = collectorClass.getMethod("boolean isInt(java.lang.String)");
        condition = collectorClass.getMethod("void condition(java.lang.String,java.lang.String,java.lang.String,int,int)");
        updateLocal = collectorClass.getMethod("void updateLocal(java.lang.String,java.lang.String,java.lang.String,java.lang.String,java.lang.String,int)");  //22 May 2018 added 1 more String for current method
        idenStmt = collectorClass.getMethod("void idenStmt(java.lang.String,java.lang.String,int)");
    ...
    protected void internalTransform(Body b, String phaseName, Map options) 
    {
        ...
        currentMethod = method.method().getName();
        ...
        while (iter.hasNext()) {
            ...
            if (!iter.hasNext()) 
            {
                if (!method.getName().contains("main")) {
                    addToMap(insertMapBefore, u, returnMethod(currentMethod,u.toString()));
...
//                        }
            ...
            if (u instanceof JReturnStmt) {
                ...
                System.out.println("CURR METHOD:" + currentMethod);         //added 22 May 2018 for current method
                addToMap(insertMapBefore, u, updateLocal(currentMethod, jReturnStmt.toString(), op, stmtCount));
...
//	}
    private Chain<Unit> updateLocal(String currMethod, String lhs, Value rhs, int lineNum) {      ////added 22 May 2018 for current method
...
//       }
        ...
        args.add(IntConstant.v(lineNum));       //added Jun 14 2018 for line number
    ...
    private Chain<Unit> identityStmt(String currMethod, String var, int lineNum) {
        ...
        args.add(IntConstant.v(lineNum));
